...
class DashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      body: SafeArea(
        top: false, // kita atur padding top manual
        child: Builder(
          builder: (context) {
            ...
            // Konten produk mulai DI BAWAH kartu profil
            ...
            return Stack(
              children: [
                ...
                // ====== HEADER (fixed) ======
                Positioned(
                  left: 0, right: 0, top: 0, height: headerH,
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        // Title di ATAS-TENGAH (pakai GoogleFonts seperti maumu)
                        Positioned.fill(
                          child: Padding(
